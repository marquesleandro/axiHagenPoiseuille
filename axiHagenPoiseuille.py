...
Kzzr, Krrr, Mr, M1r, Mr2, Gr, Gz, Grr, Gzr, polynomial_order = assembly.AxiElement2D(simulation_option, polynomial_option, FreedomDegree, numNodes, numElements, IEN, z, r, gausspoints)
