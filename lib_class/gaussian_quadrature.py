...
class AxiElement2D:
 ...
 def mini(_self,_e):
  ...
  for k in range(0,_self.NUMGAUSS):
   ...
   # Shape Functions Derivatives in respect to l1
   #dN1/dl1
   dNdl1[k][0] = - 3.0*(9.0/2.0)*( 1.0 - _self.GQPoints[k][0] - _self.GQPoints[k][1])**2\
                 + 2.0*(9.0/2.0)*( 1.0 - _self.GQPoints[k][0] - _self.GQPoints[k][1])\
                 - 1.0         

   #dN2/dl1
   dNdl1[k][1] =   13.5*_self.GQPoints[k][0]**2 - 9.0*_self.GQPoints[k][0] + 1.0

   #dN3/dl1
   dNdl1[k][2] =   0.0

   #dN4/dl1
   dNdl1[k][3] =   27.0*_self.GQPoints[k][1] - 54.0*_self.GQPoints[k][0]*_self.GQPoints[k][1] - 27.0*_self.GQPoints[k][1]**2


   # Shape Functions Derivatives in respect to l2
   #dN1/dl2
   dNdl2[k][0] = - 3.0*(9.0/2.0)*( 1.0 - _self.GQPoints[k][0] - _self.GQPoints[k][1])**2\
                 + 2.0*(9.0/2.0)*( 1.0 - _self.GQPoints[k][0] - _self.GQPoints[k][1])\
                 - 1.0         
   ...
   #dN3/dl1
   dNdl2[k][2] =   13.5*_self.GQPoints[k][1]**2 - 9.0*_self.GQPoints[k][1] + 1.0

   #dN4/dl1
   dNdl2[k][3] =   27.0*_self.GQPoints[k][0] - 54.0*_self.GQPoints[k][0]*_self.GQPoints[k][1] - 27.0*_self.GQPoints[k][0]**2
 ...
 def quadratic(_self,_e):
  ...
  for k in range(0,_self.NUMGAUSS):
   ...
   _self.dNdl2[k][3] = -4.0*_self.GQPoints[k][0]                                    #dN4/dl2
   _self.dNdl2[k][4] =  4.0*_self.GQPoints[k][0]                                    #dN5/dl2
   _self.dNdl2[k][5] =  4.0 - 8.0*_self.GQPoints[k][1] - 4.0*_self.GQPoints[k][0]   #dN6/dl2
 ...
 def assembleMv_linear(_self,_e):
  _self.NUMNODE = 3  #Linear Triangular Element - 3 Nodes
 ...
 def assembleMv_quadratic(_self,_e):
  _self.NUMNODE = 6  #Quadratic Triangular Element - 6 Nodes
